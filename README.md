[![Test Pipeline](https://github.com/nexomis/{{pipeline name}}/actions/workflows/test.yml/badge.svg?branch=main)](https://github.com/nexomis/{{pipeline name}}/actions/workflows/test.yml)
